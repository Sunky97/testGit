...
if (session.getAttribute("id") == null) {
	//로그인창으로 보냄 
	log = "<a href='/loginForm.jsp?page=/index.jsp' class='w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white'>로그인</a>";
} else {

	log = "<a href='/logout.jsp' class='w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white'>로그아웃</a>";
}
%>
<!DOCTYPE html>
<html lang="en">
...
<body>
	...
	<div class="w3-top">
		<div class="w3-bar w3-red w3-card w3-left-align w3-large">
			...
			<%=log%>
			<a href="/board.jsp"
				class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">Board</a>
			<a href="#"
				class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">Book</a>
		</div>
